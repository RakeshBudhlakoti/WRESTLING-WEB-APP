...
export default function StoryDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex-1 bg-background text-white pb-20">
      ...
      {isPlaying && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-4 animate-in fade-in duration-200">
          <button 
            ...
            className="absolute top-6 right-6 w-12 h-12 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors z-50"
          >
            <X className="w-6 h-6 text-white" />
          </button>
          <div className="w-full max-w-5xl aspect-video rounded-2xl overflow-hidden bg-black shadow-2xl relative">
            <iframe 
      ...
      {/* Hero Media */}
      <div className="w-full h-[60vh] md:h-[70vh] relative bg-black group">
        <img 
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <Link href={`/athletes/${id}`} className="flex items-center gap-4 hover:opacity-80 transition-opacity">
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-surface-hover">
                ...
                <div className="flex items-center gap-3">
                  <button className="w-10 h-10 rounded-full bg-surface/80 backdrop-blur border border-surface-hover flex items-center justify-center hover:bg-surface transition-colors text-white">
      ...
      <div className="container mx-auto px-4 mt-12 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-surface border border-surface-hover rounded-3xl p-6 sticky top-24">
              <h3 className="font-bold text-xl mb-6">Engagement</h3>
              
              <div className="flex items-center justify-between mb-8 pb-8 border-b border-surface-hover">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="space-y-4">
                  <div className="bg-surface-hover rounded-xl p-4">
                    ...
                    <p className="text-sm text-zinc-300">Incredible resilience, Marcus. Keep pushing!</p>
                  </div>
                  <div className="bg-surface-hover rounded-xl p-4">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-6 h-6 rounded-full bg-zinc-700 overflow-hidden">
                    ...
                    <p className="text-sm text-zinc-300">This gave me chills. Good luck at state!</p>
                  </div>
                </div>
              </div>

              {/* Login CTA */}
              <div className="bg-[#1C1C1C] border border-[#333333] rounded-2xl p-6 text-center">
                ...
                <Link href="/login" className="block w-full py-3 bg-brand-yellow text-black font-bold rounded-xl hover:bg-yellow-400 transition-colors text-sm">
                  Log in to Engage
                </Link>
                <Link href="/register" className="block w-full py-3 mt-2 text-white font-bold rounded-xl hover:bg-surface-hover transition-colors text-sm">
                  Create an Account
                </Link>
              </div>
