...
export default async function EditStory({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 py-12 bg-background min-h-screen">
      <div className="w-full max-w-3xl bg-surface border-x border-gray-100 p-8 md:p-12 md:rounded-3xl shadow-2xl">
        
        <div className="flex items-center gap-4 mb-8">
          <Link href="/dashboard/stories" className="w-10 h-10 rounded-full bg-surface-hover hover:bg-zinc-800 flex items-center justify-center transition-colors border border-gray-100">
            <ArrowLeft className="w-5 h-5 text-gray-900" />
          </Link>
          <div>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Edit Story</h1>
        ...
        <form className="space-y-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3.5 bg-surface-hover border border-gray-100 rounded-xl text-gray-900 placeholder-muted focus:outline-none focus:ring-1 focus:ring-brand-yellow focus:border-brand-yellow transition-all"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-2">Category</label>
                <select className="w-full px-4 py-3.5 bg-surface-hover border border-gray-100 rounded-xl text-gray-900 focus:outline-none focus:ring-1 focus:ring-brand-yellow transition-all appearance-none">
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3.5 bg-surface-hover border border-gray-100 rounded-xl text-gray-900 placeholder-muted focus:outline-none focus:ring-1 focus:ring-brand-yellow focus:border-brand-yellow transition-all resize-y font-mono text-sm"
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-start gap-6">
                  <div className="w-48 h-32 bg-surface-hover rounded-xl overflow-hidden border border-gray-100 shrink-0 relative group">
                    ...
                    <div className="absolute inset-0 bg-gray-500 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                      <Upload className="w-6 h-6 text-gray-900" />
                    </div>
                  </div>
                  <div>
                    <button type="button" className="flex items-center gap-2 px-4 py-2 bg-surface-hover border border-gray-100 rounded-xl hover:bg-zinc-800 transition-colors font-bold text-sm mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8 mt-8 border-t border-gray-100 justify-end">
            <Link href="/dashboard/stories" className="px-8 py-3.5 bg-surface-hover text-gray-900 font-bold rounded-xl hover:bg-zinc-800 transition-colors border border-gray-100 text-center">
              Cancel
            </Link>
