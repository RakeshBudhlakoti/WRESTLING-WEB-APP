    ...
    <div className="flex-1 bg-background text-white pb-20">
      <div className="container mx-auto px-4 mt-12 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          {/* IMAGES */}
          <div className="bg-surface border border-surface-hover rounded-2xl p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              <ImageIcon className="w-5 h-5 text-brand-yellow" />
              <h2 className="text-sm font-black uppercase tracking-wider text-brand-yellow">IMAGES</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="block text-xs font-bold text-muted mb-3">Cover Picture Background</label>
                <div className="flex items-center gap-4 bg-surface-hover border border-surface-hover rounded-xl p-2 pr-4 mb-2">
                  <label className="cursor-pointer bg-brand-yellow text-black font-bold px-6 py-2 rounded-lg hover:bg-yellow-400 transition-colors text-xs shrink-0">
                    Choose File
                    <input type="file" className="hidden" accept="image/*" />
                  </label>
                  <span className="text-white text-xs truncate">No file chosen</span>
                </div>
          ...
          <div className="bg-surface border border-surface-hover rounded-2xl p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-sm font-black uppercase tracking-wider text-brand-yellow">PERSONAL DETAILS & ABOUT ME</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-surface-hover border border-surface-hover rounded-xl text-white placeholder-muted focus:outline-none focus:ring-1 focus:ring-brand-yellow transition-all text-sm"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full px-4 py-3 bg-surface-hover border border-surface-hover rounded-xl text-white placeholder-muted focus:outline-none focus:ring-1 focus:ring-brand-yellow transition-all resize-y text-xs font-mono leading-relaxed"
              />
            </div>
          </div>
          ...
          <div className="flex justify-end gap-4">
            <Link href="/dashboard" className="px-8 py-3 bg-surface-hover border border-surface-hover text-white font-bold rounded-xl hover:bg-zinc-800 transition-colors text-sm">
              Cancel
            </Link>
          ...
          <div className="bg-surface border border-surface-hover rounded-2xl p-6 md:p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/submit" className="flex items-center gap-2 px-4 py-2 bg-surface-hover border border-surface-hover rounded-full hover:bg-zinc-800 transition-colors text-xs font-bold">
                + Add Story
              </Link>
            </div>
            
            <div className="bg-[#111111] border border-surface-hover rounded-xl p-4 flex items-center justify-between">
              <div>
                <h3 className="font-bold text-sm mb-1">The Road to State: Overcoming the Impossible</h3>
                <p className="text-xs text-muted">Wrestling isn't just a sport; it's a life lesson...</p>
              </div>
              <div className="flex items-center gap-2">
                <Link href="/stories/1/edit" className="w-8 h-8 rounded-md bg-[#2A2A00] text-brand-yellow flex items-center justify-center hover:bg-[#3A3A00] transition-colors border border-brand-yellow/30">
          ...
          <div className="bg-surface border border-surface-hover rounded-2xl p-6 md:p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-surface-hover border border-surface-hover rounded-full hover:bg-zinc-800 transition-colors text-xs font-bold">
                + Add Testimonial
              </button>
            </div>
            
            <div className="space-y-4">
              <div className="bg-[#111111] border border-surface-hover rounded-xl p-5 flex items-start justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-bold text-sm">Coach Richards</h3>
              ...
              <div className="bg-[#111111] border border-surface-hover rounded-xl p-5 flex items-start justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-bold text-sm">Jake Thompson</h3>
                    <div className="flex text-brand-yellow">
                      <Star className="w-3 h-3 fill-current" />
                      <Star className="w-3 h-3 fill-current" />
                      <Star className="w-3 h-3 fill-current" />
