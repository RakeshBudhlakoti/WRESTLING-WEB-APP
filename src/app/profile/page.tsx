      ...
      <div className="container mx-auto px-4 mt-12 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-12">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-3 w-full md:w-auto shrink-0 mt-4 md:mt-0">
            ...
            <Link href="/profile/edit" className="flex items-center gap-2 px-6 py-2.5 bg-surface border border-surface-hover text-white font-bold rounded-xl hover:bg-surface-hover transition-colors">
              <Edit className="w-4 h-4" /> Edit Profile
            </Link>
            <button className="flex items-center gap-2 px-6 py-2.5 bg-surface border border-surface-hover text-red-500 font-bold rounded-xl hover:bg-surface-hover transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {activeTab === 'about' && (
              <div className="bg-surface border border-surface-hover rounded-2xl p-8 space-y-8">
                <section>
                  <h3 className="text-brand-yellow font-bold uppercase tracking-wider mb-4">My Journey</h3>
          ...
          <div className="space-y-8">
            <div className="bg-surface border border-surface-hover rounded-2xl p-8 sticky top-8">
              ...
              <button className="w-full py-3 bg-surface-hover rounded-xl hover:bg-zinc-800 transition-colors font-bold text-white border border-surface-hover">
                Direct Message
              </button>
            </div>
          </div>
