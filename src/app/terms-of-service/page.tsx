    ...
    <div className="flex-1 bg-background text-white py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-8">
          <span className="text-white block">TERMS OF</span>
        ...
        <div className="bg-surface border border-surface-hover rounded-2xl p-8 md:p-12 space-y-8 text-zinc-300 leading-relaxed text-sm md:text-base">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">2. User Accounts</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">3. Content and Conduct</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">4. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">5. Termination</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">6. Changes</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">7. Contact Us</h2>
            <p>
